...
const { enviarMensagem, getWhatsAppStatus, getInstanceStatus, createInstance, getQrCode, deleteInstance, restartInstance, logoutInstance, saveConfig, getConfig, listarLogs, limparLogs } = require("../controllers/whatsappController");
