    ...
    <div className="rn-admin-shell">
      ...
      <aside className={`rn-admin-sidebar ${sidebarOpen ? "open" : ""}`}>
        <div className="rn-admin-sidebar__brand-block">
          ...
          {isSuperAdmin && (
            <div className="rn-admin-sidebar__head" style={{ padding: 0, border: "none", display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              <Link to="/super/system" className="rn-nav-item rn-super-link" onClick={() => setSidebarOpen(false)}>
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
